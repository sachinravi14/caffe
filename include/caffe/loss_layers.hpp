...
template <typename Dtype>
class NoneThresholdAccuracyLayer : public Layer<Dtype> {
 public:
  
  explicit NoneThresholdAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_NONE_THRESHOLD_ACCURACY;
  }
...
template <typename Dtype>
class NoneEntropyAccuracyLayer : public Layer<Dtype> {
 public:
  
  explicit NoneEntropyAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline LayerParameter_LayerType type() const {
    return LayerParameter_LayerType_NONE_ENTROPY_ACCURACY;
  }
